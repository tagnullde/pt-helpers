...
def run_masscan(
    ...
    # masscan 1.3.2 writes status to stderr in the form:
    #   rate:  49.83-kpps, 2.95% done, 0:00:33 remaining, found=234
    ...
    def read_stderr():
        ...
        for line in proc.stderr:
            ...
            m_rem   = re.search(r"(\d+:\d+:\d+)\s*remaining", line)
            ...
            if m_rem:   state["rem"]   = m_rem.group(1)
